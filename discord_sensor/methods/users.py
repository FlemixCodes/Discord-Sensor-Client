...
class UsersCategory(BaseCategory):
    async def _get_events(self, user_id: int, limit: int, page: int, events_type: str):
    ...
    async def get_server_history(self, user_id: int, limit: int, page: int):
        return await self._get_events(user_id, limit, page, "server_history")

    async def get_boost_history(self, user_id: int, limit: int, page: int):
        return await self._get_events(user_id, limit, page, "boost_history")

    async def get_about_me_history(self, user_id: int, limit: int, page: int):
        return await self._get_events(user_id, limit, page, "about_me_history")

    async def get_voice_history(self, user_id: int, limit: int, page: int):
        return await self._get_events(user_id, limit, page, "voice_history")
